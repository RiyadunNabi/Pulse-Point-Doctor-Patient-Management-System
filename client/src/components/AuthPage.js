...
//                       "flex-1 px-6 py-3 text-sm font-semibold rounded-lg transition-all duration-300 transform",
//                       mode === r
//                         ? "bg-white text-sky-700 shadow-md scale-105 border border-sky-200"
...
//               <button
//                 className={clsx(
//                   "flex-1 py-4 px-6 text-sm font-semibold transition-all duration-300 relative",
//                   view === 'login'
...
//                 Sign In
//                 {view === 'login' && (
//                   <div className="absolute bottom-0 left-0 right-0 h-0.5 bg-sky-600 transform scale-x-100 transition-transform duration-300"></div>
//                 )}
//               </button>
//               <button
//                 className={clsx(
...
//             <PulsePointLogo className="w-16 h-16" />
//           </div>
//           <h1 className="text-3xl font-bold text-white mb-2">Pulse Point</h1>
//           <p className="text-white/80 text-sm">Doctor-Patient Management System</p>
//         </div>

//         {/* Role Selection */}
//         <div className="flex justify-center space-x-1 bg-white/20 backdrop-blur-sm p-1 rounded-lg">
//           {roles.map(r => (
//             <button
//               key={r}
//               onClick={() => setMode(r)}
...
//             <button className="text-white/60 hover:text-white">Help</button>
//             <button className="text-white/60 hover:text-white">Contact</button>
