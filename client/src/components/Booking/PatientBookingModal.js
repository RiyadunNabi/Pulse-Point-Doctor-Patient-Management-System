...
//   // Existing functions (keeping same logic)
...
//                 {(!healthData.latest_health_log && (!healthData.medical_documents || healthData.medical_documents.length === 0)) && (
