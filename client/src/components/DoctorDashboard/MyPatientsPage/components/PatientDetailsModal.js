...
const PatientDetailsModal = ({ patient, onClose }) => {
    ...
    useEffect(() => {
        const fetchPatientDetails = async () => {
            try {
                setLoading(true);
                const response = await axios.get(`/api/doctor-patients/patient/${patient.patient_id}`);
                                    ...
                                    <div className="space-y-3">
                                        <div className="flex items-center space-x-3">
                                            ...
                                            <span className="text-sm text-slate-700">
                                                <span className="font-medium">Age:</span> {patient.age || 'Not specified'} years
                                            </span>
                                        </div>
                                        <div className="flex items-center space-x-3">
                                        ...
                                        <div className="flex items-center space-x-3">
                                            <Calendar className="w-4 h-4 text-blue-500" />
                                            <span className="text-sm text-slate-700">
                                                <span className="font-medium">Date of Birth:</span> {patient.date_of_birth ? formatDate(patient.date_of_birth) : 'Not specified'}
                                            </span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-xl p-6 border border-green-200">
                                    ...
                                    <div className="space-y-3">
                                        <div className="flex items-center space-x-3">
                                            ...
                                            <span className="text-sm text-slate-700">
                                                {patient.phone_no || 'No phone number'}
                                            </span>
                                        </div>
                                        <div className="flex items-center space-x-3">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        {patient.blood_group && (
                                            <div>
                                                ...
                                                <span className="ml-2 text-sm text-red-600">{patient.blood_group}</span>
                                            </div>
                                        )}
                                        {patient.health_condition && (
                                            <div>
                                                <span className="text-sm font-medium text-red-700">Health Condition:</span>
                                                <span className="ml-2 text-sm text-red-600">{patient.health_condition}</span>
                                            </div>
                                        )}
                                    </div>
                                </div>
                                                ...
                                                <div className="flex items-center justify-between">
                                                    <div>
                                                        ...
                                                        <div className="text-sm text-slate-600">
                                                            Dr. {appointment.doctor_first_name} {appointment.doctor_last_name} • {appointment.department_name}
                                                        </div>
                                                        {appointment.reason && (
