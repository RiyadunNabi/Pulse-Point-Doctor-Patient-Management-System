...
// import { Heart, Activity, TrendingUp, Settings, Plus, Edit3 } from 'lucide-react';
...
//           {/* Recent Logs with Edit Functionality */}
//           <div className="mt-6">
//             <h4 className="text-sm font-semibold text-slate-700 mb-3">Recent Logs</h4>
//             <div className="space-y-2 max-h-40 overflow-y-auto">
//               {healthLogs.slice(0, 5).map((log) => (
//                 <div key={log.logid} className="flex justify-between items-center p-3 bg-slate-50 hover:bg-slate-100 rounded-lg transition-colors">
...
//                       {log.blood_sugar && (
//                         <span className="text-slate-700">
//                           <span className="text-slate-500">Sugar:</span> {log.bloodsugar}mg/dL
//                         </span>
//                       )}
//                     </div>
