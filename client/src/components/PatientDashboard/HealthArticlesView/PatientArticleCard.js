    ...
    const handleImageModal = (imageSrc) => {
        ...
        modal.innerHTML = `
            <div class="relative max-w-4xl max-h-full">
                <img src="${imageSrc}" class="max-w-full max-h-full object-contain rounded-lg shadow-2xl" />
                ...
                <div className="prose prose-slate max-w-none">
                    ...
                    {safeArticle.content && safeArticle.content.length > 200 && (
                        <button
                            ...
                            className="text-emerald-600 hover:text-emerald-700 font-medium text-sm mt-2 inline-flex items-center space-x-1"
                        >
                ...
                <div className="px-6 mt-4">
                    <div className="relative group">
                        <img 
                            ...
                            onClick={(e) => handleImageModal(e.target.src)}
                        />
                ...
                <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-6">
                        ...
                        <button className="flex items-center space-x-2 text-slate-500 hover:text-emerald-500 transition-colors">
                            ...
                            <span className="text-sm">Ask Doctor</span>
                        </button>
...
export default PatientArticleCard;
